---
layout: "squadcast"
page_title: "squadcast: squadcast_test"
sidebar_current: "docs-squadcast-test"
description: |-
  The squadcast_test resource allows squadcast tests to be managed by Terraform.
---

# squadcast\_test

The test resource allows squadcast tests to be managed by Terraform.

## Example Usage

```hcl
resource "squadcast_test" "google" {
...
squadcast test can be imported using the test id, e.g.

```
tf import squadcast_test.example 123
```